...
#ifndef _SHA_SC_FOREIGN_INCLUDED_
#define _SHA_SC_FOREIGN_INCLUDED_
...
struct sha : public ncsc_foreign_module
{
public:
    ...
    const char* hdl_name() const { return "sha"; }
...
#endif /* _SHA_SC_FOREIGN_INCLUDED_ */
