...
// Date        : Wed Mar  4 15:36:40 2020
// Host        : socp04 running 64-bit CentOS Linux release 7.5.1804 (Core)
// Command     : write_verilog -cell inst_33 -force
//               /home/esp2020/yl4337/SHA/SystemC/Embedded_Scalable_Platform/syn/bdw_work/modules/sha/BASIC/v_gates/sha_Add_33Sx8S_32S_4.v
// Design      : sha_Add_33Sx8S_32S_4
...
module sha_Add_33Sx8S_32S_4
  ...
  CARRY8 \out1[0]_INST_0 
       (.CI(\<const0> ),
        ...
        .DI({in1[7],in2[6:0]}),
        .O(out1[7:0]),
        .S({\out1[0]_INST_0_i_1_n_0 ,\out1[0]_INST_0_i_2_n_0 ,\out1[0]_INST_0_i_3_n_0 ,\out1[0]_INST_0_i_4_n_0 ,\out1[0]_INST_0_i_5_n_0 ,\out1[0]_INST_0_i_6_n_0 ,\out1[0]_INST_0_i_7_n_0 ,\out1[0]_INST_0_i_8_n_0 }));
  LUT2 #(
    .INIT(4'h6)) 
    \out1[0]_INST_0_i_1 
       (.I0(in1[7]),
  ...
  CARRY8 \out1[8]_INST_0 
       (.CI(\out1[0]_INST_0_n_0 ),
        ...
        .DI({in2[14:8],\out1[8]_INST_0_i_1_n_0 }),
        .O(out1[15:8]),
        .S({\out1[8]_INST_0_i_2_n_0 ,\out1[8]_INST_0_i_3_n_0 ,\out1[8]_INST_0_i_4_n_0 ,\out1[8]_INST_0_i_5_n_0 ,\out1[8]_INST_0_i_6_n_0 ,\out1[8]_INST_0_i_7_n_0 ,\out1[8]_INST_0_i_8_n_0 ,\out1[8]_INST_0_i_9_n_0 }));
  LUT1 #(
    .INIT(2'h1)) 
    \out1[8]_INST_0_i_1 
       (.I0(in1[7]),
